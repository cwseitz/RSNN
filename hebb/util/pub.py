...
def fig_3(N=100, q1=0.2, q2=0.8, sigma_e=5, sigma_i=5, p_e=0.8):
    ...
    ax1.set_axis_off()
    ax1.text(-0.1, 1.0, 'B', transform=ax1.transAxes, size=14, weight='bold')
    ...
    format_ax(ax2,
              ...
              ax_is_box=False)
    ax2.text(-0.4, 1.1, 'C', transform=ax2.transAxes, size=14, weight='bold')
    ...
    ax6.set_axis_off()
    ax6.text(-0.1, 1.0, 'D', transform=ax6.transAxes, size=14, weight='bold')
    ...
    ax7.text(-0.3, 1.1, 'E', transform=ax7.transAxes, size=14, weight='bold')
    format_ax(ax7,
              xlabel=r'$\sigma_{I}$',
              ylabel=r'$\langle I_{I}\rangle/N_{I}$',
              ax_is_box=False)
